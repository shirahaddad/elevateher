...
export default function Footer() {
  return (
    <footer className="bg-purple-900 text-white py-6" role="contentinfo" aria-label="Site footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link href="/blog" className="text-sm text-purple-100 hover:text-white">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/learn-more" className="text-sm text-purple-100 hover:text-white">
                  Get Started
                </Link>
              </li>
              <li>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-1 flex flex-col items-center md:items-start">
              ...
              <li className="text-sm text-purple-100">
                <Link href="/newsletter" className="hover:text-white flex items-center gap-2">
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
                    viewBox="0 0 24 24"
